...
{
    internal class CompleteApplicationForClientHandler : IRequestHandler<CompleteApplicationForClientCommand, Guid>
    {
        private readonly IApplicationsDbContext _dbContext;

        public CompleteApplicationForClientHandler(IApplicationsDbContext dbContext) =>
            _dbContext = dbContext;

        public async Task<Guid> Handle(CompleteApplicationForClientCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                application.Status = ApplicationStatus.CompletedForClient;
